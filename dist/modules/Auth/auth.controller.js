...
const login = (0, catchAsync_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const _b = yield auth_service_1.authService.loginUser(loginData), { refreshToken } = _b, others = __rest(_b, ["refreshToken"]);
    const cookieOptions = {
    ...
    (0, catchAsync_1.sendResponse)(res, {
        ...
        success: true,
        message: `${(_a = others.user) === null || _a === void 0 ? void 0 : _a.role} logged in successfully`,
        data: {
